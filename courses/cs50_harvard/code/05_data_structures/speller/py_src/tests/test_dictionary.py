...
class TestSizeAndDunders:
    ...
    def test_size_empty(self, empty_dictionary: DictionaryProtocol) -> None:
        """size() returns 0 for unloaded dictionary."""
        assert empty_dictionary.size() == 0

    def test_size_after_load(self, loaded_dictionary: DictionaryProtocol) -> None:
        """size() returns correct count after loading."""
        assert loaded_dictionary.size() > 0

    def test_len_matches_size(self, loaded_dictionary: DictionaryProtocol) -> None:
    ...
    def test_contains_missing_word(self, loaded_dictionary: DictionaryProtocol) -> None:
        """'word in dictionary' returns False for missing words."""
        assert "xyz" not in loaded_dictionary

    def test_repr_format(self, loaded_dictionary: DictionaryProtocol) -> None:
