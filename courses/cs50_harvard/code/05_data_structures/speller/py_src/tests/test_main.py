...
class TestValidatePaths:
    ...
    def test_valid_path_return_none(
        ...
        """
        result_dict = _validate_paths(sample_dict_file, path_name=sample_dict_file.name)
        result_text = _validate_paths(sample_text_file, path_name=sample_text_file.name)

        assert result_dict is None
        assert result_text is None

    def test_missing_path_returns_exit_code(self, sample_text_file: Path) -> None:
